  ...
  return (
    <div data-aos="fade-up" className="amenities-second">
      ...
      <div className="amenities-first-text">
        <p>
          An Investment that will enable you to achieve consistent and above
          market Rental Returns. The Reveal, Sets the standard for revolutionary
          architectural innovation and premier living experience in the heart of
